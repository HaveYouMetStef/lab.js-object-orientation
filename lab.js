...
let cat1 = new Cat('Jasper', 2, 'Black')
...
//Code Here
const phoneOne = new phone('motorola', '10', '152', 'black', '$120')
phoneOne.sell();
const phoneTwo = new phone('iphone', '10', '152', 'black', '$100')
phoneTwo.sell();
const phoneThree = new phone('android', '10', '152', 'black', '$90')
phoneThree.sell();
/* 
...
//Code Here 
phoneOne.changePrice();
console.log(phoneOne.brand ,'changed their price from $120 to', '$100');
...
//Code Here
const myFirstVehicle = new Vehicle(5, "Black", 20000)
...
//Code Here 
const myFirstMotorcycle = new Motorcycle(1, "White", 10000, "Honda", "Yes")
/*
...
class Boat extends Vehicle {
  ...
  checkSeaworthiness(){
    if(this.isSeaworthy === true) {
      console.log('The', this.color, this.name, 'is seaworthy!');
    } else {
...
//Code Here
const myFirstBoat = new Boat(3, 'Blue', 100, 'Lagune', 'speed boat', false)
/*
